(function($) {
  ...
  var skills = document.querySelectorAll('.skill-bar-inner');
  skills.forEach(function(bar) {
    var percent = bar.getAttribute('data-percent');
    if (bar.getBoundingClientRect().top < window.innerHeight - 50 && bar.style.width === '') {
...
window.addEventListener('DOMContentLoaded', animateSkills);
  ...
  $("#owl-demo").owlCarousel({
    items: 3, // Number of certificates visible
    loop: true,
    margin: 20,
    autoplay: true,
